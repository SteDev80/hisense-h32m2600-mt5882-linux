...
#define MT5882_CBAR_VIRT 0xF2100000
static unsigned long mt5882_cbar_phys;
static struct map_desc mt5882_cbar_desc __initdata = {
    .virtual = MT5882_CBAR_VIRT,
    .pfn = 0,
    .length = SZ_32K,
    .type = MT_DEVICE,
};
...
static void __init mt53xx_init_machine_irq(void)
{
    ...
    struct irq_chip *gic;
#if defined(CONFIG_ARCH_MT5882)
    pr_info("MT5882 CBAR: physical 0x%08lx, virtual 0x%08x\n",
            mt5882_cbar_phys, MT5882_CBAR_VIRT);
    gic_init(0, 29,
             (void __iomem *)(MT5882_CBAR_VIRT + 0x1000),
             (void __iomem *)(MT5882_CBAR_VIRT + 0x2000));
#else
...
#ifdef CONFIG_CPU_V7
#if defined(CONFIG_HAVE_ARM_SCU) || defined(CONFIG_ARM_GIC)
...
#if defined(CONFIG_ARCH_MT5882)
    /* Cortex-A7 CBAR reports the actual private-peripheral/GIC base. */
    asm volatile ("mrc p15, 4, %0, c15, c0, 0" : "=r" (mt5882_cbar_phys));
    mt5882_cbar_phys &= ~(SZ_32K - 1);
    mt5882_cbar_desc.pfn = __phys_to_pfn(mt5882_cbar_phys);
    iotable_init(&mt5882_cbar_desc, 1);
#endif
