...
$logPath = 'C:\Users\steki\Documents\Codex\2026-08-30\referenced-chatgpt-conversation-this-is-an\outputs\buildroot-h32m2600\uart-p27-boot.txt'
$all = ''
    ...
    while ([DateTime]::UtcNow -lt $deadline) {
        ...
        if ($text) {
            ...
            if ($all -match '=== MT5882 BUILDROOT RESCUE READY ===') {
                [Console]::WriteLine("`r`n[HOST] H32LINUX_P27_READY")
                break
            }
        }
        Start-Sleep -Milliseconds 20
